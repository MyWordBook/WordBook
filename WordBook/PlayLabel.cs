    ...
    public partial class PlayLabel : UserControl
    {
        ...
        private void DiscriptionText()
        {
            DiscriptiontextBox.Text = string.Format(
                ...
                "▶推奨の学習サイトはTALKENGLISH.com(https://www.talkenglish.com/)です。デフォルトで登録してあるカテゴリーはこちらのサイトのものです。練習をする内容を一通り把握した後に練習に移ります。また、Sentenceを登録したい場合は、www.ManyThings.org（http://www.manythings.org/o/）というサイトに豊富な例文と音声があるので、ここでサイト内検索をするとほとんどの場合登録に困らないでしょう。" + Environment.NewLine +
